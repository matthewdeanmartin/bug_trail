...
[example code-as-config](https://github.com/matthewdeanmartin/bug_trail/blob/main/packages/bug-trail/example_code_as_config.py)
...
- [PyPI](https://pypi.org/project/bug-trail/)
